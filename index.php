        ...
        <div class="card pl-4 pl-md-5 pr-3">
            <div class="row">
                <div class="left-side col-md-5">
                    <p class="pt-5 mb-0">wellcome to</p>
                    <h3 class="mb-0"><strong>Watashi laundry</strong></h3> <small class="">dijamin aman, wangi, dan bersih</small>
                </div>
                <div class="right-side col-md-7 row justify-content-center">
                    <div class="d-flex"> <img class="boy-img fit-image" src="https://i.redd.it/z9jqh73buxz41.jpg"> </div>
                </div>
            </div>
        </div>
    </div>
